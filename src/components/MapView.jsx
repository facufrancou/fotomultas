...
export function MapView({ smooth, camerasWithDistance, vehicleId, registerRecenter }) {
  return (
    <div className={styles.container}>
      ...
      >
        ...
        <VehicleMarker smooth={smooth} vehicleId={vehicleId} registerRecenter={registerRecenter} />
      </MapContainer>
    </div>
  );
}
